        ...
        >
            <div class="p-6">
                ...
                <p class="text-slate-400 text-sm mb-6">
                    Elige cómo quieres enviar tu correo a <span class="text-emerald-400 font-medium">{COMPANY_EMAIL}</span>
                </p>
                ...
                <div class="space-y-3">
                    ...
                    >
                        <span class="font-medium text-white group-hover:text-emerald-400 transition-colors">Gmail</span>
                    ...
                    <button 
                        ...
                        class="w-full flex items-center justify-between p-4 rounded-xl bg-slate-800/50 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 transition-all group"
                    >
                        <span class="font-medium text-white group-hover:text-blue-400 transition-colors">Outlook / Hotmail</span>
                    ...
                    <button 
                        ...
                        class="w-full flex items-center justify-between p-4 rounded-xl bg-slate-800/50 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 transition-all group"
                    >
                        <span class="font-medium text-white group-hover:text-purple-400 transition-colors">Yahoo Mail</span>
